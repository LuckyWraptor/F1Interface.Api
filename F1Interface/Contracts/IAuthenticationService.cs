...
namespace F1Interface.Contracts
{
    public interface IAuthenticationService
    {
        ...
        /// <exception cref="AuthenticationException">Authentication failure exception</exception>
        Task<TokenObject> AuthenticateF1TVTokenAsync(string sessionToken, string identityProvider = default);
        /// <summary>
        /// Authenticate token for F1TV access
        /// </summary>
        ...
        /// <returns>Authentication token response</returns>
        /// <exception cref="AuthenticationException">Authentication failure exception</exception>
        Task<TokenObject> AuthenticateF1TVTokenAsync(IPage page, string sessionToken, string identityProvider = default);
    }
}